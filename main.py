...
# BG color
BACKGROUND = pygame.Color('navajowhite')  # Light neutral cream background
BOARD_COLOR_A = pygame.Color('burlywood')  # Light wood-tone for the lighter squares
BOARD_COLOR_B = pygame.Color('saddlebrown')  # Darker wood-tone for the darker squares
HOVER_COLOR = pygame.Color('goldenrod')  # Golden color for hover effect
...
def loadSoundEffects():
    ...
    effects = {}
    move_piece = pygame.mixer.Sound('./assets/sounds/move_sound.mp3')
    undo_move = pygame.mixer.Sound('./assets/sounds/undo_moves.wav')
    checkmate = pygame.mixer.Sound('./assets/sounds/checkmate_sound.mp3')
...
def loadImages():
    ...
    for piece in pieces:
        image = pygame.image.load('./assets/images/' + piece + '.png')
...
def drawButtons(WINDOW, GAME_STATE):
    ...
    # Draw a black box
    # Draw a black circle
    pygame.draw.circle(WINDOW, pygame.Color('black'), (25, 405), 15)

    # Draw a white circle below the black circle
    pygame.draw.circle(WINDOW, pygame.Color('white'), (25, 455), 15)
    ...
    black_ai = pygame.Color('brown') if BLACK_AI else pygame.Color('gainsboro')
    black_man = pygame.Color(
        'brown') if BLACK_MAN else pygame.Color('gainsboro')

    makeButton(WINDOW, TOGGLE_BUTTON_2_POS, BUTTON_WIDTH,
               BUTTON_HEIGHT, TEXT='BOT', BTN_COLOR=black_ai, BTN_RADIUS=15)
    ...
    white_ai = pygame.Color('brown') if WHITE_AI else pygame.Color('gainsboro')
    white_man = pygame.Color(
        'brown') if WHITE_MAN else pygame.Color('gainsboro')

    makeButton(WINDOW, TOGGLE_BUTTON_4_POS, BUTTON_WIDTH,
               BUTTON_HEIGHT, TEXT='BOT', BTN_COLOR=white_ai, BTN_RADIUS=15)
    ...
    while running:
        ...
        if GAME_STATE.checkMate:
            ...
            if GAME_STATE.whiteToMove:
                drawGameOverText(WINDOW, 'Black wins by Checkmate', 'Black')
            else:
                drawGameOverText(WINDOW, 'White wins by Checkmate', 'Black')
        ...
        if GAME_STATE.staleMate:
            gameOver = True
            drawGameOverText(WINDOW, 'Stalemate', 'Green')
